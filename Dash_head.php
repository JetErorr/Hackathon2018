...
<body >
  ...
  <div class="dashnav" >
	...
	<!--   <a href="javascript:void(0);" onclick="calltha();" class="resbar"> <i class="fa fa-bars"></i> </a> -->
	  ...
	  <a href="#"><i class="fa fa-group"></i> Abou Us</a>
  ...
  <div class="w3-row" style="border:0px solid blue;">
				  ...
				  <div id="leftsideb" class="sidenav w3-col" style="border:0px solid black;height:900px;background-color: #222d32;clear:all;" align="center">
							...
							<?php
							    ...
							    <a href="dashboard.php" id="dash_bord" class=" "><i class="fa fa-dashboard"></i> Dashboard</a>
							    <a href="dashboard_portfolio.php" id="dash_mskill" class=" "><i class="fa fa-pencil"></i> Portfolio</a>
							    <a href="#" id="dash_profll" class=" "><i class="fa fa-user-circle-o"></i> Profile</a>
							    <a href="dashboard_profile_update.php" id="dash_updainf" class=" "><i class="fa fa-cogs"></i> Update Info</a>
							    <a href="dashboard_complain.php" id="dash_compln" class=" "><i class="fa fa-exclamation-triangle"></i> Compliant</a>
							    <a href="#" id="dash_helpd" class=" "><i class="fa fa-question"></i> Help</a>
