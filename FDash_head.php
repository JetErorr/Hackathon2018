  ...
  <div class="w3-row" style="border:0px solid blue;">
				  ...
				  <div id="leftsideb" class="sidenav w3-col" style="border:0px solid black;height:900px;background-color: #222d32;clear:all;" align="center">
							...
							<?php
							    ...
							    <a href="Fdashboard.php" id="dash_bord" class=" "><i class="fa fa-dashboard"></i> Dashboard</a>
							    <a href="Fprofile.php" id="dash_profll" class=" "><i class="fa fa-user-circle"></i> Profile </a>
							    <a href="#" id="dash_student" class=" "><i class="fa fa-address-card"></i> Students</a>
							    <a href="#" id="dash_mskill" class=" "><i class="fa fa-file-text"></i> Tenders & Proposal </a>
							    <a href="#" id="dash_updainf" class=" "><i class="fa fa-cogs"></i> Payments </a>
							    <a href="#" id="dash_helpd" class=" "><i class="fa fa-bell"></i> Notification</a>
							    <a href="#" id="dash_updainf" class=" "><i class="fa fa-cogs"></i> Update Info </a>
